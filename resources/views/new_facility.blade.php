        ...
        <div class="row">
            <div class="card col m6 offset-m3" style="margin-top:20px;">
                ...
                <form method="POST" action="{{ route('facilities.store') }}">
                    ...
                    <div class="input-field">
                        <select name="lga" id="lga" class="select-lga browser-default" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="geocordinates">Geo Cordinate</label>
                            <input type="text" name="geocordinate" id="geocordinates" class="form-control">
