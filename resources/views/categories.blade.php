                        ...
                        @foreach ($categories as $cat)
                            <tr>
                                ...
                                <td><button class="label label-primary" id="ach{{ $cat->id }}"
                                        ...
                                        data-title="{{ $cat->title }}" data-category_group="{{ $cat->category_group }}"
                                        data-description="{{ $cat->description }}"
                                        data-business_id="{{ $cat->business_id }}">Edit</button>
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('addcategory') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_group" id="category_group" class="form-control"
                                placeholder="e.g. Materials, Products, Suppliers, Distributors">
