            ...
            <form action="{{ route('saveClient') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input list="banklist" name="bank" id="bank" class="form-control" placeholder="Bank Name">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group date" id="start_date_activator" data-target-input="nearest">
                            <input type="text" name="retirement_date" class="form-control datetimepicker-input"
                                data-target="#start_date_activator" value="{{ isset($client->retirement_date) ?? '' }}">
                ...
                <div style="font-size: 0.7em">
                    ...
                    <p><b>Terms and Conditions</b><br>
                        1. This document shall be interpreted as the governing document of the transaction where in all the
                        fundamental terms binding both parties are contained and referenced to this form shall be reference
                        to the contractual agreement upon which said transaction is formed. <br>
                        2. Items requested for, shall be picked up at designated places and date upon the commencement of
                        deduction of the cost of the item requested. items delivered on the agreed time and not collected by
                        the customer shall attract additional transport cos t of N5,000 only.<br>
                        3. Where the company fails to supply the requested item after the number of deduction agreed by the
                        customer either by reason of availability of the product, delay in shipping, clearing or otherwise;
                        the customer will be duly noticed on the state of the item.<br>
                        4. Where the circumstance in 3(above) occur, the customer is at liberty to enter fresh negotiation
                        ...
                        accepted once same is delivered to the customer, through the company may at its discretion consider
                        genuine complaints from customers and proffer any remedy it might deem expedient<br>
                        7. No cancelation of transaction when deduction has commenced. The company may allow cancellation in
                        some special circumstances provided that; the applicant will forfeit 30% of the total deduction
                        made.<br>
                        8. Cancellation of transaction by applicant after 5(five) working days of registration attracts a
                        contingency/administrative fee of N7,000 only<br>

                        I hereby declare that I fully understand the legal consequences, economic and commercial obligation
                        incurred by virtue of my subscription to the scheme as offered by Accessmade Limited and therefore
                        authorize Accesmade Limited to effect a monthly deduction of the amount against my name from my
                        monthly salary for the purpose of defraying the cost of the asset I am obtaining through Accessmade
                        Limited. I sincerely and expressly agree to be bound by the terms and condition herein contained and
                        declared that I shall abide by said terms and agree to be held accountable wherever I am in default.
